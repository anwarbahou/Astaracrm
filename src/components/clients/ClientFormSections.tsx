...
export const ProfileSection = ({ formData, t }: { formData: ClientFormData, t: TFunction }) => (
...
export const BasicInfoSection = ({ formData, setFormData, t }: SectionProps) => (
...
export const BusinessInfoSection = ({ formData, setFormData, t }: SectionProps) => (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div>
...
export const TagsSection = ({ tags, onTagsChange, t }: TagsSectionProps) => {
...
export const NotesSection = ({ notes, onNotesChange, t }: NotesSectionProps) => (
    <div>
